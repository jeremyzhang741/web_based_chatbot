...
definitions = {'definitions': {'Ask': {'type': 'object', 'properties': {'input': {'type': 'string', 'example': 'hi'}}}, 'inline_response_400': {'properties': {'message': {'type': 'string'}}}}, 'parameters': {}}
...
filters = {
    ('ask', 'POST'): {200: {'headers': None, 'schema': {}}, 400: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string'}}}}, 404: {'headers': None, 'schema': None}},
}
